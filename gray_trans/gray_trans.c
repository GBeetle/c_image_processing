...
void gray_trans(void (*p) (short**, short**, long, long), short**, short**, long, long);
void reverse(short**, short**, long, long);
void logarithm(short**, short**, long, long);
void gamma(short**, short**, long, long);
...
int main(int argc, char const *argv[])
{
    ...
    gray_trans(reverse, in_array, out_array, h, w);
    // gray_trans(logarithm, in_array, out_array, h, w);
    // gray_trans(gamma, in_array, out_array, h, w);
    // gray_trans(histogram_equalization, in_array, out_array, h, w);
...
void gray_trans(void (*p) (short**, short**, long, long), short** in_array, short** out_array,
                long height, long width)
{
    p(in_array, out_array, height, width);
}
